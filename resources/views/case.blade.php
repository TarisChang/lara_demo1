            ...
            <ul>
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/59670cf4c272a.jpg" alt=""></a>
                    </div>
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/59671086a6543.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>航天航海</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/5967480a215f3.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/596714a6c9664.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>門窗加工</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/59674831c07c9.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
                                    <p>門窗加工</p>
                                </div>
                            </div>
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/596715343fb0e.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>汽車制造</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/5967483f13c1b.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/59326712c6242.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>高速銲接</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/59674853c7a54.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/5932670ac25e0.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>高速立曏上銲</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/59674ac4a4246.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/593266315465a.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>高速脈沖銲</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/59674ad6cf678.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
                ...
                <li>
                    <div class="bg-list-img">
                        <a href="javascript:void(0)"><img src="/assets/picture/59326640ef281.jpg" alt=""></a>
                    </div>
                    <div class="bg-list-tit">
                        <h4>超級雙脈沖銲</h4>
                    </div>
                    ...
                    <div class="i_pro_bg">
                        <a href="javascript:void(0)">
                            <div class="bg-list-hs"
                                style=" background:url(images/59674aa856e5e.png) center top no-repeat;background-size:100% 100%">
                                <div class="bg-list-sub-hs">
